...
describe('Card', () => {
  ...
  it('renders each tag as its own hashtag', () => {
    ...
    expect(screen.getByRole('button', { name: 'Filter by React' })).toHaveTextContent('#React')
    expect(screen.getByRole('button', { name: 'Filter by type script' })).toHaveTextContent(
      '#typescript',
    )
  })
