...
describe('Select', () => {
  ...
  it('calls onChange when an option is clicked', () => {
    ...
    render(<Select options={options} onChange={onChange} aria-label="Choose" />)
    fireEvent.click(screen.getByRole('combobox'))
  ...
  it('shows placeholder when provided', () => {
    render(<Select options={options} placeholder="Select one…" aria-label="Choose" />)
  ...
  it('shows selected value label when value is set', () => {
    render(<Select options={options} value="b" aria-label="Choose" />)
