...
describe('InputAction', () => {
  ...
  it('displays controlled value and clear button when non-empty', () => {
    render(<InputAction icon={<MockIcon />} value="typed value" onChange={() => {}} />)
  ...
  it('calls onChange when input changes', () => {
    ...
    render(<InputAction icon={<MockIcon />} onChange={onChange} actionAriaLabel="Action" />)
  ...
  it('clears input when clear button is clicked', () => {
    const onChange = vi.fn()
    render(<InputAction icon={<MockIcon />} value="some text" onChange={onChange} />)
  ...
  it('renders optional label when provided', () => {
    render(<InputAction label="Hours" value="" onChange={() => {}} placeholder="HH" />)
